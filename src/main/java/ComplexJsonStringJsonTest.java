 ...
 **/
public class ComplexJsonStringJsonTest {
    ...
    public static  void main(String [] args){
        ...
        System.out.println("jsonTemplow"+jsonTemplow+","+"jsonTempHigh"+jsonTempHigh+","+"jsonWeather"+jsonWeather+","+
                "jsonTempnow"+jsonTempnow+","+"jsonWinddirect"+jsonWinddirect+","+"jsonWindpower"+jsonWindpower+","+
                "jsonHumidity"+jsonHumidity);

        //利用JSONArray进行复杂解析,取得json对象中的属性值为Array的属性
        ...
        for (Object obj : jsonDaily) {
            JSONObject partDaily = (JSONObject) obj;
            System.out.println("date:  " + partDaily.getString("date") + ":" +
                    " week:" + partDaily.getString("week")+
                    " weather:" + partDaily.getString("weather")
            );
        }
